...
function startG(me) {
    ...
    currentColor = topCard.color; isMyTurn = me;
...
document.getElementById("playAgainBtn").onclick = () => { if (isMultiplayer && playerHand.length === 0) startG(true); else if (!isMultiplayer) startG(true); };
